    ...
    <div class="container">
        ...
        <div class="welcome">
            ...
            <?php if ($credits <= 0): ?>
                <div class="credits-box" style="background:#fee2e2; border-color:#fecaca; color:#991b1b;">
                    ...
                    <a href="/frontend/buy_credits.php" class="btn red">
                        Comprar créditos
                    </a>
                </div>
        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <a href="/frontend/select_mode.php" class="btn blue">
                    Crear
                </a>
            </div>
            ...
            <div class="card">
                ...
                <a href="/frontend/templates_list.php" class="btn gray">
                    Ver templates
                </a>
            </div>
            ...
            <div class="card">
                ...
                <a href="/frontend/cfdi_list.php" class="btn gray">
                    Ver historial
                </a>
            </div>
