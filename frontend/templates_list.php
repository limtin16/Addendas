    ...
    <div class="container">
        ...
        <?php else: ?>
            ...
            <?php foreach ($templates as $tpl): ?>
                ...
                <a href="/backend/public/load_template.php?id=<?= $tpl['id'] ?>" class="btn blue">
                    Usar template
                </a>

                <form method="POST" action="/backend/public/delete_template.php">
        ...
        <?php endif; ?>
            ...
            <a class="back" href="/frontend/dashboard.php">
                ⬅ Volver
            </a>
